...
def test_mean_reversion_7d():
    """Test mean reversion with 7d horizon data"""
    ...
    print("=== MEAN REVERSION TEST (7D DATA) ===")
...
def test_mean_reversion_time_shift_7d():
    """Time-shift test for mean reversion with 7d data"""
    ...
    print(f"\n=== TIME-SHIFT TEST (MEAN REVERSION 7D) ===")
...
if __name__ == "__main__":
    portfolio_return, win_rate, signals = test_mean_reversion_7d()
    normal, shifted = test_mean_reversion_time_shift_7d()
