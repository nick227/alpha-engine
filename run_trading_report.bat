...
powershell -Command "$end = (Get-Date).ToString('yyyy-MM-dd'); $start = (Get-Date).AddDays(-30).ToString('yyyy-MM-dd'); python run_paper_trading.py --report-only --start-date $start --end-date $end"
