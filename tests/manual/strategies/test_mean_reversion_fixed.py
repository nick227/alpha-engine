...
def test_mean_reversion_fixed():
    """Test mean reversion with correct date alignment"""
    ...
    print("=== MEAN REVERSION TEST (FIXED) ===")
...
if __name__ == "__main__":
    portfolio_return, win_rate, signals = test_mean_reversion_fixed()
