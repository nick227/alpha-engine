...
from app.ui.comparison.comparison_schema import ComparisonCard, ComparisonSorter, ComparisonFilter
...
class DetailedComparisonView:
    ...
    def render_detailed_view(card: ComparisonCard) -> None:
        ...
        from app.ui.comparison.comparison_renderer import ComparisonChartRenderer
